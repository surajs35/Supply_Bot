/*
Team Id: 1121
Author List:  Suraj S, Swaroop R,Roshan Nayak, Vaishak MS.
Filenane: SB#1121
Theme: Supply Bot.
Functions:uart.c(whole file containing functions),striking(), motor_control(int ADCvalue1,int ADCvalue2,int ADCvalue3),
          motor_direction(),uart0_readByte(),ADCsingleREAD(uint8_t adctouse),timer2_init(), brightness(unsigned char red_led),led_init()
		  init_devices(),led_init(),led_redoff(),led_redon(),stopping(),main()
Global Variables:ADCVALUE1,ACDCVALUE2,ADCVALUE3,rx_byte
*/
/*************************************************************************
...
#define m3 PORTD7
#define m4 PORTB0
#define PIN_LED_RED	 PORTB5
#define striker PORTB1
int ADCvalue1; 
int ADCvalue2;
int ADCvalue3;
char rx_byte; 
...
? * Output: 5V to striking the coin using 300rpm dc motor
? * Logic: declaring the ddr resistor to output pin and output high to the pin
********************************************************************************/void striking(void){
	DDRB|=(1<< striker);
	PORTB|=(1<<striker);
	//using 5V 300 rpm motor
}
/******************************************************************************
? * Function Name: motor_direction
? * Output: taking pins of arduino as output 
? * purpose:declare the ddr resistor as output or input
...
? * Input: recieves the data from XBEE module connected to laptop
? * Output: returns the recieved data 
...
? * Input: sensor's analog values
? * Output: digital values of sensor values from 0-255
? * Logic:conversion of sensor's analog values to digital using inbuilt adc module
...
? * Output: setting the timer
? * purpose: to control speed of the motor
 ******************************************************************************/void timer2_init()
{
...
? * Input: sensor's digital values
? * Output: movement of the bot
